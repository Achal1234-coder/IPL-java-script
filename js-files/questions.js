...
// programme start from this line.
main();


// Its work to stop and start i.e toggle the graph.
// Its run when press start and stop button.
function stop(){
...
// main function thats work is change and fetch the data of different question.
function main(){
    let url;
    let yText;
    let xText;
...
// Its works to delay a graph
function late(value = "Stop"){
    if(value === "Start"){
        time = setTimeout(main, 200);
    }
    else{
        time = setTimeout(main, 4000);
    }
}


// Its work to convert the json data into highchart understable array.
...
// Its plot a highchart graph for question no 1, 2, 3.
...
// Its plot a graph for question no 4.
